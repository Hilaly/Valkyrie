...
{
    class CemGraphEdgeConnectorListener : IEdgeConnectorListener
    {
        private readonly BaseGraphView _baseGraphView;
        ...
        public CemGraphEdgeConnectorListener(BaseGraphView baseGraphView)
        {
            _baseGraphView = baseGraphView;
