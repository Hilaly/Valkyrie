    ...
    public static class SimulationCompiler
    {
        ...
        internal static void Recompile()
        {
            ...
            if (components.Count > 0)
            {
                ...
                CreateSimulationServiceScript(targetPath);
            }

            Debug.Log($"Valkyrie: regenerate components finished");
        }

        static void CreateSimulationServiceScript(string resultFilePath)
        {
            ...
            fb.Write($"private void Update() => {MonoTypeName}.DoUpdate(UnityEngine.Time.deltaTime);");
            fb.EndClass();
